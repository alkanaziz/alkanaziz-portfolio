...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    // emailjs
    //   .sendForm('service_nhkur1q', 'template_ioe1kmg', formRef.current, {
    //     publicKey: 'bSIycyb5dGuTZvLRr',
    //   })
    //   .then(
    //     () => {
    //       setSuccess(true);
    ...
    const handleSubmit = async () => {
      try {
        const serviceID = 'service_nhkur1q';
        const templateID = 'template_ioe1kmg';
        const publicKey = 'bSIycyb5dGuTZvLRr';
        setLoading(true);
